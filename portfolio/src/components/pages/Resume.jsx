...
import pcresume from "../../assets/resume/pcResume.docx.pdf"
    ...
    return (
        <div className="card m-4">
            ...
            <ul className="row ml-2 mr-2 mb-5">
                            ...
                            <li className="col-sm-12 col-md-4 font-weight-light mb-2"><img style={{width: "2rem"}}src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img,w_800,h_672/https://boffincoders.com/wp-content/uploads/2021/05/bootstrap1.png" alt="Bootstrap" /> BootStrap</li>
